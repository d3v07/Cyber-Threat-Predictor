...
--
-- Host: localhost
-- Generation Time: Sep 29, 2022 at 07:45 AM
...
(4, 'tmksmanju1', 'tmksmanju13@gmail.com', 'tmksmanju1', '9535866270', 'India', 'Karnataka', 'bangalore');
...
(33, 'Naive Bayes', '60.67527308838133'),
(34, 'SVM', '57.19960278053625'),
(35, 'Logistic Regression', '58.788480635551146'),
(36, 'Extra Tree Classifier', '57.49751737835154');
...
(22, 'Packet Drop', '50.0'),
(23, 'Packet Hijacking', '50.0');

-- --------------------------------------------------------

--
-- Table structure for table `remote_user_detect_cyber_threat`
--

CREATE TABLE IF NOT EXISTS `remote_user_detect_cyber_threat` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `pid` varchar(3000) NOT NULL,
  `ptime` varchar(3000) NOT NULL,
  `src_ip_address` varchar(3000) NOT NULL,
  `dst_ip_address` varchar(3000) NOT NULL,
  `frame_protos` varchar(3000) NOT NULL,
  `src_port` varchar(3000) NOT NULL,
  `dst_port` varchar(3000) NOT NULL,
  `bytes_trans` varchar(3000) NOT NULL,
  `protocol` varchar(3000) NOT NULL,
  `Date1` varchar(3000) NOT NULL,
  `Prediction` varchar(3000) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=8 ;

--
-- Dumping data for table `remote_user_detect_cyber_threat`
--

INSERT INTO `remote_user_detect_cyber_threat` (`id`, `pid`, `ptime`, `src_ip_address`, `dst_ip_address`, `frame_protos`, `src_port`, `dst_port`, `bytes_trans`, `protocol`, `Date1`, `Prediction`) VALUES
(1, '172.217.6.202-10.42.0.211-443-47447-6', '31:38.4', '149.171.126.16', '175.45.176.3', 'sll:ethertype:ip:tcp', '389', '29795', '48', 'TCP', '08-08-19 16:06', 'Packet Drop'),
(2, '172.217.12.170-10.42.0.151-443-49883-6', '31:38.6', '149.171.126.16', '175.45.176.3', 'sll:ethertype:ip:tcp:ldap', '389', '29795', '473', 'TCP', '08/21/19 10:55', 'Packet Hijacking'),
(3, '10.42.0.42-66.198.178.91-52456-443-6', '32:00.9', '149.171.126.16', '175.45.176.1', 'sll:ethertype:ip:tcp', '80', '8630', '48', 'TCP', '08/21/19 00:48', 'Packet Hijacking'),
(5, '10.42.0.151-10.42.0.1-9903-53-17', '32:14.1', '149.171.126.16', '175.45.176.3', 'sll:ethertype:ip:tcp', '25', '55442', '48', 'TCP', '08-08-19 6:09', 'Packet Drop'),
(6, '10.42.0.211-98.139.225.43-50554-443-6', '32:14.7', '149.171.126.16', '175.45.176.3', 'sll:ethertype:ip:tcp:vssmonitoring', '25', '55442', '40', 'TCP', '08/30/19 09:07', 'Packet Drop'),
(7, '10.42.0.151-104.244.43.99-50129-443-6', '32:58.8', '149.171.126.16', '175.45.176.2', 'sll:ethertype:ip:tcp', '80', '47285', '1500', 'UDP', '08-01-19 9:42', 'Packet Hijacking');
